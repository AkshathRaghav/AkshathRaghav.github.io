...
* Smr'24: I'm interned at [VLSI System Design](https://www.vlsisystemdesign.com/), a semiconductor ed-tech platform, where I implemented the [TinySpeech](https://arxiv.org/abs/2008.04245) family of speech recognition models tailored for edge-deployment. I also wrote an [ANSI-C based inference engine](https://github.com/AkshathRaghav/tinyspeech) which runs out-of-box in 8bit precision, with 91%+ accuracies on the CH32V003F4U6 chip (2kb volatile sram, 16kb external mem). 
