...
{% include figure.liquid loading="eager" path="assets/img/tldr/etran/cls_initial.png" title="4xample image" class="img-fluid rounded z-depth-1" %}
 <div class="caption">
    *Remember, this is a naive example*.
</div>
...
* Non-Gaussian distributions: LDA assumes that the features within each class are normally distributed. The projections might not accurately reflect the seperability in this case. 
