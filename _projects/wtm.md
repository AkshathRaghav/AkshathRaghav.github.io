...
<img-comparison-slider>
  ...
  {% include figure.liquid path="assets/img/559/2/parex.png" class="img-fluid rounded z-depth-1" slot="second" %}
</img-comparison-slider>
<div class="caption">
...
{% include figure.liquid loading="eager" path="assets/img/559/wtm.png" title="example image" class="img-fluid rounded z-depth-1" %}
<div class="caption">
